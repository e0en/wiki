...
def spellCorrection(string):
    url = \
        'http://search.yahooapis.com/WebSearchService/V1/spellingSuggestion?appid=%s&query=%s&output=json&callback=?' % (
            wikiSettings.yahoo_api_id, urllib.quote(string.encode('utf8')))
